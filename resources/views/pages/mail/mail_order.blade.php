...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>Phí ship:</strong> {{ number_format($shipping_array['fee'], 0, ',', '.') }} VNĐ</li>
        </ul>
        ...
        <strong>Tổng tiền thanh :</strong> {{ number_format($totalPayment + $shipping_array['fee'], 0, ',', '.') }} VNĐ <!-- Hiển thị tổng tiền thanh toán -->
